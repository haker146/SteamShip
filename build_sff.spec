...
icon_path = os.path.join(spec_root, 'steamship.ico')
...
if os.path.exists(os.path.join(spec_root, 'steamship.png')):
    datas.append(('steamship.png', '.'))
if os.path.exists(os.path.join(spec_root, 'steamship.ico')):
    datas.append(('steamship.ico', '.'))
pattern_dir = os.path.join(spec_root, 'pattern')
if os.path.isdir(pattern_dir):
    datas.append((pattern_dir, 'pattern'))
