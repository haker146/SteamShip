...
SteamShip's **Fixes & Bypasses** feature fetches a curated game fix list from the CrakFiles repository on GitHub and downloads the selected fix directly into your game folder.
...
**Raw JSON (what SteamShip fetches):**
```
...
| Field | Type | Description |
|---|---|---|
| `href` | string | Download URL (buzzheavier.com). This is what SteamShip downloads. |
...
- The fix list covers games not available on online-fix.me and games that need a standalone crack or bypass SteamShip can apply directly.
