...
SteamShip can search and apply game fixes and bypasses from a curated list hosted on GitHub.

## When to use it

Use this if:

- The game isn't available on online-fix.me, or you want a fix source SteamShip can apply directly.
- You want a second source after the online-fix browser search does not find what you need.
...
3. SteamShip fetches the fix list and shows matches for your game first.
