...
How to run SteamShip from source or build the EXE yourself.

> Most users should use the pre-built EXE from [GitHub Releases](https://github.com/haker146/SteamShip/releases/latest). This guide is for developers and advanced users only.
...
Then run `dist\SteamShip_GUI.exe`.
