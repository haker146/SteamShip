...
def uninstall_context_menu():
    keys_to_delete = [
        r"SOFTWARE\Classes\*\shell\SteamShip\command",
        r"SOFTWARE\Classes\*\shell\SteamShip",
