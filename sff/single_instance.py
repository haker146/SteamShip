...
"""
Single-instance guard for SteamShip.
...
class SingleInstanceGuard:
    ...
    def try_activate_existing(self, message: str = "SHOW") -> bool:
        """
        Try to connect to an already-running SteamShip instance.
        ...
        if sock.waitForConnected(_CONNECT_TIMEOUT_MS):
            ...
            logger.info("Existing SteamShip instance found — forwarding %s request", message)
            return True
        return False
