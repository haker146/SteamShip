...
SteamShip now only helps you find the right page; you follow their guide manually.
"""
...
def _show_new_system_message():
    ...
    print()
    print("1. Select or search for your game in SteamShip.")
    print("2. Try LC Online-Fix on the game first.")
    print("3. If LC Online-Fix does not work for that game, SteamShip can help")
    ...
    print("   guide says.")
    print()
    print("This change was made because I do not want SteamShip to automatically")
    print("download Online-Fix files or cause extra problems for Online-Fix.")
    print("SteamShip will only help you find/open the page, then you follow their")
