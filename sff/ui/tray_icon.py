...
"""
System tray icon for SteamShip.
...
class TrayIcon(QObject):
    ...
    def _create_tray(self):
        ...
        self._tray.setToolTip("SteamShip")
        self._build_menu()
        ...
        # see SteamShip is alive there even when the icon is overflowed.
        try:
    ...
    def _build_menu(self):
        ...
        show_action = QAction("Show SteamShip", self._menu)
