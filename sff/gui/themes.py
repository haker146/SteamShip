...
HARBOR_STYLE = _gen_dark_variant(
    bg="#0b1220", fg="#e8eef5", accent="#c9a227", btn_bg="#182235",
    btn_hover="#223049", input_bg="#121a2b", border="#1e2a40"
)
...
def theme_background(key: str) -> str:
    """Hex bg colour for a theme key. Falls back to Harbor on unknown keys."""
    return THEME_BACKGROUNDS.get(key, THEME_BACKGROUNDS["harbor"])
...
TITLEBAR_COLORS = {
    "harbor":    {"bg": "#080e18", "fg": "#e8eef5", "accent": "#c9a227", "close": "#e81123", "border": "#1e2a40"},
