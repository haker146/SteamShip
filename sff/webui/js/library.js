...
window.Library = (function() {
    ...
    function _applyLibraryFilter(filter) {
        ...
        if (_managedOnly) {
            games = games.filter(function(g) { return !!g.steamship_managed; });
        }
    ...
    function _createLibraryCard(game, index) {
        ...
        if (game.steamship_managed) {
            var badge = document.createElement('div');
            badge.className = 'steamship-managed-badge';
            badge.textContent = 'SM';
            badge.title = 'Added with SteamShip';
