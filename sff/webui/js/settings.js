...
window.Settings = (function() {
    ...
    var THEMES = [
        { id: 'harbor', name: 'Harbor', bg: '#0b1220', accent: '#c9a227' },
    ...
    function _renderThemePicker() {
        ...
        picker.innerHTML = '';
        var currentTheme = document.documentElement.getAttribute('data-theme') || 'harbor';
    ...
    function _initPathControls() {
        ...
        var apiSaveMap = {
            ...
            'setting-steamship-pt-save': { input: 'setting-steamship-pt-repo', key: 'steamship_pt_repo', label: 'Pattern repo' },
        };
    ...
    function _initAboutLinks() {
        ...
        if (githubLink) {
            githubLink.addEventListener('click', function(e) {
                e.preventDefault();
                Bridge.call('open_url', 'https://github.com/haker146/SteamShip');
            });
        }
            ...
            updateLink.addEventListener('click', function(e) {
                ...
                Bridge.callWithCallback('app_update_check', '', function(json) {
                    ...
                    if (!data.update_available) {
                        resetUpdateButton();
                        Components.showToast('success', 'SteamShip is already up to date.');
                        return;
                    }
        ...
        if (clearBtn) {
            clearBtn.addEventListener('click', function() {
                Bridge.callWithCallback('clear_custom_background', function(json) {
                    ...
                    var themeId = document.documentElement.getAttribute('data-theme') || 'harbor';
                    _applyTheme(themeId);
    ...
    function _loadCurrentSettings() {
        Bridge.callSync('get_all_settings', function(json) {
            try {
                ...
                _setInputVal('setting-steamship-pt-repo', settings.steamship_pt_repo);
                ...
                // Theme
                if (settings.theme) {
                    var displayedTheme = document.documentElement.getAttribute('data-theme') || 'harbor';
