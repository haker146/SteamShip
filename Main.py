...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
                        ...
                        description='SteamShip - set up games for Steam with Lua scripts, manifests, and LumaCore',

                        epilog='https://github.com/haker146/SteamShip/releases')
    ...
    if args.version:
        ...
        print(f"SteamShip version {VERSION}")
