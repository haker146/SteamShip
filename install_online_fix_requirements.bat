@echo off
echo ========================================
echo  Installing SteamShip Requirements
echo ========================================
echo.
...
echo ========================================
echo.
echo  Tor Expert Bundle lets SteamShip automatically fall back to
echo  the Tor network when the primary GMRC endpoint is down.
echo  Without it, the tool falls back to ManifestHub API / manual
echo  code entry instead. It is NOT required to use SteamShip.
echo.
...
if /i "%TOR_CHOICE%"=="Y" (
    ...
    echo  Leave it running while using SteamShip.
)
